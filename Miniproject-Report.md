...
## Step 6: Verification of reads representing ssDNA sequences using kaiju virus database with a kaiju script named kaiju-virus-dna-identifier.sh
...
### Blastn script named blast-results.sh
